...
const navbarStyles = {
	...
	container:
		'mx-auto flex w-full max-w-[1440px] items-center justify-between px-1.5 text-white transition-[padding] duration-300 sm:px-2.5 lg:px-3',
	containerTop: 'py-3',
	...
	menu: 'absolute left-1/2 hidden -translate-x-1/2 items-center gap-2 lg:gap-3 md:flex',
	...
	actions: 'ml-auto flex items-center gap-2 lg:gap-3',
}
